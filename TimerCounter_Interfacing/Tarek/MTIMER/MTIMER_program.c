...
#define NULL                     ((void*)0)
#define TIMER0_PH_CORRET_MODE    (0x60)
#define TIMER1_PH_CORRET_MODE    (0x8100)
#define TIMER2_PH_CORRET_MODE    (0x60)
...
static void mtimer_start(u8_t au8_timerChannel)
{
    ...
    switch(au8_timerChannel)
    {
        ...
        case TIMER_CHANNEL_1:
            ...
            /*Setting the timer1 prescaler and start its operation*/
...
void mtimer_init(u8_t au8_timerChannel, u16_t au16_timerMode, u8_t au8_timerPrescaler)
{
    ...
    switch(au8_timerChannel)
    {
        ...
        case TIMER_CHANNEL_0:
            ...
            if(au16_timerMode == (u16_t)TIMER0_PWM_MODE)
            {
                ...
                if(au8_timerPrescaler > TIMER_PH_CORRECT_OFFSET)
                {
                    ...
                    au16_timerMode = (u16_t)TIMER0_PH_CORRET_MODE;
        ...
        case TIMER_CHANNEL_1:
            ...
            /*Checking if the timer mode chosen is PWM mode or not*/
            if(au16_timerMode == (u16_t)TIMER1_PWM_MODE)
            {
                /*Checking if the chosen PWM mode is phase correct or fast PWM*/
                if(au8_timerPrescaler > TIMER_PH_CORRECT_OFFSET)
                {
                    /*Setting phase correct mode*/
                    au16_timerMode = (u16_t)TIMER1_PH_CORRET_MODE;
        ...
        case TIMER_CHANNEL_2:
            ...
            /*Checking if the timer mode chosen is PWM mode or not*/
            if(au16_timerMode == (u16_t)TIMER2_PWM_MODE)
            {
                /*Checking if the chosen PWM mode is phase correct or fast PWM*/
                if(au8_timerPrescaler > TIMER_PH_CORRECT_OFFSET)
                {
                    /*Setting phase correct mode*/
                    au16_timerMode = (u16_t)TIMER2_PH_CORRET_MODE;
...
void mtimer_delayMs_synchronous(u8_t au8_timerChannel, u32_t au32_delayTime_ms)
{
    ...
    switch(au8_timerChannel)
    {
        ...
        case TIMER_CHANNEL_1:
            ...
            /*Setting the OCR1A value to make a compare match after 1ms*/
        ...
        /*Setting the OCR2 value to make a compare match after 1ms*/
            MTIMER_OCR1A = TIMER_1_MS_DELAY;
...
void mtimer_delayMs_asynchronous(u8_t au8_timerChannel, u32_t au32_delayTime_ms, void (*fptr_operationPointer)(void), u8_t au8_operationType)
{
    ...
    switch(au8_timerChannel)
    {
        ...
        /*Setting the OCR1A value to make a compare match after 1ms*/
            MTIMER_OCR1A = (u16_t) TIMER_1_MS_DELAY ;
            ...
            /*Enable output compare match interrupt*/
            SET_BIT(MTIMER_TIMSK, MTIMER_TIMSK_OCIE1_BIT);
...
{    
    /*Static global variable used to track the delay time*/
    static u32_t au32_delayTemp1 = 0;

    /*Increment the delay variable*/
    au32_delayTemp1++;

    /*Checking if the delay time has passed or not*/
    if(au32_delayTemp1 == gu32_delayTimeMs_timer1)
    {
        /*Checking if the callback function is valid or not*/
...
{
    /*Static global variable used to track the delay time*/
    static u32_t au32_delayTemp2 = 0;

    /*Increment the delay variable*/
    au32_delayTemp2++;

    /*Checking if the delay time has passed or not*/
    if(au32_delayTemp2 == gu32_delayTimeMs_timer2)
    {
        /*Checking if the callback function is valid or not*/
