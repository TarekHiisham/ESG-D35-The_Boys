...
/*Timer modes*/
#define TIMER0_DELAY_MODE          (0x08)
#define TIMER1_DELAY_MODE          (0x0800)
#define TIMER2_DELAY_MODE          (0x08)

#define TIMER0_PWM_MODE            (0x68)   /*Fast PWM mode by default*/
#define TIMER1_PWM_MODE            (0x8108) /*Fast PWM mode by default*/
#define TIMER2_PWM_MODE            (0x68)   /*Fast PWM mode by default*/
...
#define TIMER1_DELAY_PRESCALER    (TIMER_PRESCALER_64)
#define TIMER2_DELAY_PRESCALER    (TIMER2_PRESCALER_64)
